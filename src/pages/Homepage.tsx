...
const HomePage = ({ onNavigate }: HomePageProps) => {
  return (
    ...
    >
      ...
      {/* NAVBAR */}
      <nav className="relative z-10 p-6 border-b-2 border-white transform -rotate-1 bg-black/40 backdrop-blur-sm">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-4">
            <button
              ...
              className="px-3 py-1 border border-white hover:bg-white hover:text-black transition-colors text-xs bg-black/40"
            >
              INSTRUCTIONS (MAYBE)
            </button>
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        <div className="relative">
          ...
          {/* DECORATIVE SVG */}
          <div className="absolute -top-10 left-0 w-full h-96 opacity-20 pointer-events-none">
          ...
          <div className="text-center mb-16 relative" style={{ marginTop: '100px', marginLeft: '-50px' }}>
            ...
            <div className="inline-block px-2 py-1 text-xs text-cyan-400 border border-cyan-400 transform rotate-2 bg-black/40">
          ...
          <div className="relative max-w-2xl mx-auto">
            ...
            <div className="bg-black/60 border-4 border-white p-8 transform -rotate-1 relative backdrop-blur-sm shadow-xl">
              ...
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="w-full py-4 border-2 border-white hover:bg-white hover:text-black transition-all transform hover:rotate-1 text-xl font-bold bg-black/40"
                ...
                <button
                  ...
                  className="w-full py-2 border border-zinc-700 hover:border-white transition-colors text-sm transform rotate-1 bg-black/40"
          ...
          <div className="mt-16 text-center">
            <div className="inline-block transform -rotate-2 border-2 border-white p-6 bg-black/50 backdrop-blur-sm">
      ...
      {/* FOOTER */}
      <footer className="relative z-10 border-t-2 border-white p-4 text-center transform rotate-1 bg-black/40 backdrop-blur-sm">
